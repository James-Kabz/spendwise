...
export default function Home() {
  return (
    <div className="min-h-screen px-6 py-12 sm:px-10 lg:px-16">
      <div className="mx-auto flex w-full max-w-8xl flex-col gap-12">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <GlassCard className="space-y-5">
            ...
            <div className="rounded-2xl border border-emerald-300/60 p-4">
              <p className="text-sm">
                Lunch budget
              </p>
            ...
            <div className="rounded-2xl border border-emerald-200/60 p-4">
              <p className="text-sm">
            ...
            <div className="rounded-2xl border border-emerald-300/60 bg-emerald-300/30 p-4">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <GlassCard tone="midnight" intensity="strong" className="space-y-4">
            ...
            <button className="rounded-full border border-slate-300 px-4 py-2 text-sm font-semibold transition hover:border-slate-400">
              Join the beta list
            </button>
          </GlassCard>
        </section>
